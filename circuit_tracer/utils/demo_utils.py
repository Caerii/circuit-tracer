...
from circuit_tracer.utils.decode_url_features import (
    Feature,
    decode_url_features,
)
...
def display_ablation_chart(
    ...
    """
    import matplotlib.pyplot as plt  # type: ignore[import-not-found]  # optional viz dep
    import numpy as np
...
def extract_supernode_features(url: str) -> dict[str, list[Feature]]:
    """Extract supernode features from a graph visualization URL.

    This is a convenience wrapper around ``decode_url_features``.
    """
