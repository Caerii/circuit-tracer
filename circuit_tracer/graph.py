...
class Graph:
    ...
    def interventions(self, n: int = 10, value: float = 0.0) -> list:
        """Return feature-intervention tuples for the top-*n* graph features."""
        from circuit_tracer.analysis import graph_to_interventions
