...
gemma_3_config_dict = {
    ...
    "use_cache": True,
    "vocab_size": 262144,
    "_name_or_path": "google/gemma-3-270m",
}
    ...
    def verify_intervention(expected_effects, intervention, target_layer):
        ...
        with model.trace() as tracer:
            ...
            with tracer.invoke():
                ...
                new_activation_cache = new_activation_cache.save()  # type: ignore
            ...
            with tracer.invoke():
                ...
                new_logits = model.output.logits.squeeze(0).save()  # type: ignore
...
def test_small_gemma_model():
    ...
    gemma_small_config = gemma_3_config
...
def test_large_gemma_model():
    ...
    gemma_large_cfg = gemma_3_config
